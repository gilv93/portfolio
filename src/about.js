...
const About = () => {
	return (
		<div className='about' id={'About Me-sec'}>
			...
			realized I understood what it meant to be totally interested and motivated by a subject, something I'd
			never felt about with chemistry. This is when I believe I had slowly, truly, become passionate
