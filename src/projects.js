...
const Projects = () => {
	...
	const projects = [
		...
		{
			name: 'Giliga',
			image: 'assets/images/giliga.png',
			description: 'My first project with Python. A small Galaga clone made using the Pygames library.',
			demo: 'NA',
			code: 'https://github.com/gilv93/giliga'
		}
	]
	...
	const skillSet = () => {
		return (
			skills.map((skill) => {
				return (
					<div className='skill-cont' key={skill.name}>
						{skill.svg}
						<p>{skill.name}</p>
					</div>
				)
			...
			projects.map((project) => {
				return (
					<div className='project-cont' key ={project.name}>
						...
						<p style={{ fontSize: '1.2em', color: '#F17300', fontStyle: 'italic', fontWeight: '600', marginTop: '0.5em'}}>{project.name}</p>
						<p>{project.description}</p>
						<div className='links'>
							{ project.demo === 'NA' ? null : <a href={project.demo} target='_blank' rel='noopener noreferrer'>View Demo</a> }
